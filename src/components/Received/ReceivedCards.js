...
height:"35px",
            ...
            >
              ...
              />
              <Typography sx={{ fontSize: "14px", color: "#FCFCFC", fontFamily: "Manrope, sans-serif", }}>
                {" "}
                Send a new Card
              </Typography>
            </Button>
...
marginTop:"10px",
            ...
            >
              <CloudDownloadIcon sx={{fontSize:"35px"}} />
          ...
          <Table>
            ...
            <TableRow>
      {columns.map((column) => (
        <TableCell key={column.accessor} sx={{
                  ...
                  return (
                    <TableRow
                      ...
                      sx={{
                        ...
                        backgroundColor: row.viewed ? "#FCFCFC" : "#e0e0e087",
                      }}
                    >
                      <TableCell
                        sx={{
...
Not because it's thanksgiving but I always wanted to Thank you , having you as my mentor has greatly enhanced my capabilities and skill set. I truly appreciate everything you have done and always will be grateful to you for your kindness and support.</p>
          <Tooltip title="Close">
            <IconButton
              edge="end"
              color="inherit"
...
export default connect(mapStateToProps)(ReceivedCards);
