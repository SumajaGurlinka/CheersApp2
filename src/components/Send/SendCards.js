...
>
  {remainingCharacters} characters left{" "}
   ...
   <div style={{ marginTop: "60px", marginLeft: "50px", display: "flex", alignItems: "center" }}>
  ...
  <div style={{ marginLeft: "auto" }}>
    ...
    <Button style={{ background: "#0071e3", color: "#FCFCFC", borderRadius: "8px", textTransform: "none" ,marginRight:"30px",width:"80px"}}>
      Submit
    </Button>
  </div>
</div>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  setEdit: dispatch.user.setEdit,
});
const mapStateToProps = (state) => ({
  user: state.user,
});

export default connect(mapDispatchToProps,mapStateToProps)(SendCards);
